# Welcome to the AI Proofreader by Lyzr!

![Lyzr Logo](./logo/lyzr-logo.png)

AI Proofreader reviews and edits simple texts or text documents. This app will help you check for grammar, spelling, punctuation, and formatting errors, it was built by using Lyzr Automata.
